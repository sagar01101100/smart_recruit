...
<head>
	...
	<title>IIT Patna Admin Profile</title>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="../company.php?ref=<?php echo "$myid"; ?>"><i class="fa fa-briefcase"></i> Overview</a>
										</li>
										<li>
											...
											<div class="row gap-20">
												...
												<div class="form-group">
													...
													<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
													   ...
													   foreach($result as $row)
													   {
														?> <option <?php if ($country == $row['category']) { print ' selected '; } ?> value="<?php echo $row['category']; ?>"><?php echo $row['category']; ?></option> <?php
