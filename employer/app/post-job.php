...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_jobs (job_id, title, city, country, category, experience, description, responsibility, requirements, date_posted, closing_date)
        VALUES (:jobid, :title, :city, :country, :category, :experience, :description, :responsibility, :requirements, :dateposted, :closingdate)");
