...
// Initialize total records count
    ...
    // Fetch total records count from tbl_jobs
                                          $stmt = $conn->prepare("SELECT COUNT(*) AS total_records FROM tbl_jobs");
                                         $stmt->execute();
...
// Calculate total pages for pagination
                                       $records_per_page = 5;
                                   $records = ceil($total_records / $records_per_page);
    ...
    // Output pagination links
                                         echo '<li class="paging-nav" ';
                                           if ($page == "1") { 
                                     echo 'class="disabled"'; 
                                                    }
                                                 echo '><a ';
                                            if ($page != "1") { 
                                        echo 'href="my-jobs.php?page='.$prevpage.'"'; 
                                                  }
                                                echo '><i class="fa fa-chevron-left"></i></a></li>';
                                                       ...
                                                       echo '><a href="my-jobs.php?page='.$b.'">'.$b.'</a></li>';
                                                          }
                                                      ...
                                                      if ($page == $records) { 
                                                         ...
                                                         echo '><a ';
                                                             if ($page != $records) { 
                                               echo 'href="my-jobs.php?page='.$nextpage.'"'; 
                                                   }
